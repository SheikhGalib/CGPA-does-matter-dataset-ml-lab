...
% ---------------------------------------------------------------- page-1 figures (framework + pipeline)
\input{figures/src/fig_styles.tex}
...
{\large\bfseries CSE 4112: Machine Learning Laboratory}\\[6mm]
...
\vspace{-7mm}
\begin{center}
\input{figures/src/framework.tex}
\end{center}
\vspace{-4mm}
{\small\itshape Figure 1(a). Practical application of the dataset, from the research question to the checked 920-student dataset, WEKA models and uses for academic advisers, department heads and students.}
...
\vspace{-5mm}
\begin{center}
\input{figures/src/pipeline.tex}
\end{center}
\vspace{-4mm}
{\small\itshape Figure 1(b). Technical pipeline (read 1$\rightarrow$4, then 5$\rightarrow$8). Cleaning rules are fixed before any model is trained, and every row is a different anonymous student, so nothing leaks between training and test folds.}
...
\textbf{Exclusion criteria.} We removed a response when (i) there was no usable CGPA answer (18 rows); (ii) there was no real recent-SGPA answer (6 rows); or (iii) it came from some SGPA and CGPA groups were two or three steps apart (182 rows). Section 8 gives the reason for each rule.
...
\begin{figure}[!htbp]
\centering
\begin{subfigure}[t]{0.40\linewidth}\centering\includegraphics[width=\linewidth]{figures/form/s04_05.png}\caption{Form heading, anonymity statement and first question}\end{subfigure}\hfill
\begin{subfigure}[t]{0.58\linewidth}\centering
\includegraphics[width=0.49\linewidth]{figures/form/s04_06.png}\hfill\includegraphics[width=0.49\linewidth]{figures/form/s04_07.png}\\[2mm]
\includegraphics[width=0.49\linewidth]{figures/form/s04_08.png}\hfill\includegraphics[width=0.49\linewidth]{figures/form/s04_09.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.40\linewidth]{figures/form/s05_05.png}\hspace{4mm}\includegraphics[width=0.50\linewidth]{figures/form/s05_06.png}\\[2mm]
\includegraphics[width=0.52\linewidth]{figures/form/s05_07.png}\hspace{4mm}\includegraphics[width=0.40\linewidth]{figures/form/s05_08.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.32\linewidth]{figures/form/s06_06.png}\hfill\includegraphics[width=0.32\linewidth]{figures/form/s06_08.png}\hfill\includegraphics[width=0.32\linewidth]{figures/form/s06_10.png}\\[2mm]
\includegraphics[width=0.32\linewidth]{figures/form/s06_12.png}\hfill\includegraphics[width=0.32\linewidth]{figures/form/s06_14.png}\hfill\includegraphics[width=0.32\linewidth]{figures/form/s06_16.png}
...
\begin{figure}[!htbp]
\centering
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{figures/deck/rc_university.png}\caption{Students per university}\end{subfigure}\hfill
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{figures/deck/rc_cgpa.png}\caption{Students per CGPA group}\end{subfigure}
